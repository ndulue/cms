                    ...
                    <div class="container-fluid">
                        ...
                        <?php 
                            if (isset($_POST['submit_comment'])) {
                                ...
                                $censor = array('poo', 'screw', 'screwed', 'screwing', 'dunce', 'insane', 'an insane');
                            
                                $censoredcomment = str_replace($word, $censor, $lower);

                                $SCquery = "SELECT * FROM comments where postid = '$id' AND comment = '$comment'";
                                $SCsql = $db->query($SCquery);
                                $SCnum = $SCsql->num_rows;

                                if ($SCnum > 0) {
                                    echo "<p class='text-center text-danger bg-danger'>Comment already exist</p>";
                                    return false;
                                    exit();
                                } else{
                        ...
                        <div class="well well-sm">
                            <div class="row">
                                ...
                                <div class="col-lg-10 col-md-10">
                                    <a href="post.php?id=<?php echo $id;?>"><h3><?php echo $Recent['title'];?></h3></a>
                                </div>
                            </div>    
                        </div>
